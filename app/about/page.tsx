      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="max-w-2xl mx-auto text-gray-800 text-sm md:text-base leading-relaxed">
            is a distinguished entity engaged in manufacturing & supplier of a
            broad range of all types of fabrics & different aprons of
            industries.
          </p>
          <p className="max-w-2xl mx-auto text-gray-800 text-sm md:text-base leading-relaxed">
            We are manufacturer and supplier of uniform fabrics in
            polyester/viscose polyester/100% cotton and many more. We also
            ensure transparency of business ethics at all stages and implement
            quality standards are parallel to the international quality
            uniforms. The workforce of the company comprises of qualifies
            professionals like designers, quality analysts, research staff,
            tailors, supervisors and marketing executives
          </p>
            ...
            <div className="grid lg:grid-cols-2 bg-white/70 backdrop-blur-xl rounded-2xl p-5 shadow-sm border border-white/50 md:gap-20">
              <div className="">
                ...
                <p className="text-gray-800 text-[15px] leading-relaxed mb-5">
                  We are a trusted manufacturer & supplier delivering premium
                  textile solutions. Our strength lies in skilled craftsmanship,
                  quality materials, and strict testing.
                </p>
              </div>
